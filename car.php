  ...
  <!--================Header Menu Area =================-->
        ...
        <div class="container">
            <div class="row">
				...
				<div class="feature-img">
                            <img class="img-fluid" src="img/blog/car.jpg" alt="">
                        </div>
                        <div class="blog_details">
                            <h1 style="color: black">Car Insurance</h1>
                            <ul class="blog-info-link mt-3 mb-4">
                                <li><a href="#"><i class="far fa-user"></i> Lifestyle</a></li>
                                <li><a href="#"><i class="far fa-comments"></i> source </a></li>
                            </ul>
                            <p class="excert">
   ...
   <a href="policyreg.php" class="genric-btn success circle" style="background-color: black"><strong>Apply Policy</strong></a>
                    ...
                    <div class="comment-form">
                        <h4>Leave a Reply</h4>
                        <form class="form-contact comment_form" action="auto.php" method="post" id="commentForm">
                            <div class="row">
                                <div class="col-12">
                    ...
                    <div class="blog_right_sidebar">
                        ...
                        <aside class="single_sidebar_widget post_category_widget">
                            ...
                            <ul class="list cat-list">
                                <li>
                                    <a href="car.php" class="d-flex">
                                        <p >Car Insurance</p>
                                     
                                    </a>
                                </li>
                                <li>
                                    <a href="bike.php" class="d-flex">
                                        <p style="color: #f84b67">Bike Insurance</p>
                                ...
                                <li>
                                    <a href="van.php" class="d-flex">
                                        <p>Van Insurance</p>
                                        
                                    </a>
                                </li>
                                <li>
                                    <a href="motorcycle.php" class="d-flex">
                                        <p>Motor Cycle Insurance</p>
                               
                                    </a>
                                </li>
                                <li>
                                    <a href="tractor.php" class="d-flex">
    ...
    <footer class="footer-area" style="background-color: #4380B8">
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-3 col-md-8 mb-4 mb-xl-0 single-footer-widget" style="color: white">
                    <h4>Newsletter</h4>
