...
<body>
 <!--================Header Menu Area =================-->
  ...
  <div class="feature-img">
                            <img class="img-fluid" src="img/blog/van.jpg" alt="">
                        </div>
                        <div class="blog_details">
                              <h1 style="color: black">Van Insurance</h1>
          ...
          <!--Comment Area-->
                    <div class="comment-form">
                        <h4>Leave a Reply</h4>
                        <form class="form-contact comment_form" action="van.php" method="post" id="commentForm">
                            <div class="row">
                                <div class="col-12">
